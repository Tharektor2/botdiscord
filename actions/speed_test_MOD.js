module.exports = {
	...
	subtitle: function (data) {
		if (data.info === "predkoscpobierania") {
			return "Speed Test - Prędkość Pobierania"
		} else if (data.info === "predkoscwysylu") {
			return "Speed Test - Prędkość Wysyłania"
		} else {
			return `Error.`
		}
	},
	...
	author: "PrewcioStream",

	// The version of the mod (Defaults to 1.0.0)
	version: "1.0.0",

	// A short description to show on the mod line for this mod (Must be on a single line)
	short_description:  "Sprawdza prędkość pobierania i wysyłania internetu.",
	...
	variableStorage: function (data, varType) {
		...
		let dataType;
		if (data.info === 'predkoscpobierania') {
			dataType = 'Prędkość Pobierania'
		} else if (data.info === 'predkoscwysylu') {
			dataType = 'Prędkość Wysyłania'
		} else {
	...
	html: function (isEvent, data) {
        ...
        <div class="embedinfo">
	    <span class="embed-auth"><u>Mod Info:</u><br>Zrobione przez <b>${this.author}</b></span><br>
	...
	<div style="float: left; width: 50%; padding-top: 8px;">
		...
		<select id="info" class="round">
			<option value="predkoscpobierania" selected>Prędkość Pobierania</option>
			<option value="predkoscwysylu">Prędkość Wysyłania</option>
		</select>
	</div>
	...
	action: function (cache) {
		...
		test.on('error', error => {
			console.log("Error podczas sprawdzania predkosci: " + error)
			_this.callNextAction(cache)
		})
	},
